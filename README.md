...
The input structures used to generate the DFT dataset during the active learning procedure are available at https://github.com/AMLS-PRG/ice-nucleation-on-feldspar/tree/main/Input_files_for_DFT.
